...
def keysA_B():
    ...
    with open("secret_keys_A.txt", "w") as f:
        print(hex(key_a_secret[0]), file=f)
        print(hex(key_a_secret[1]), file=f)
        print(hex(key_a_secret[2]), file=f)
    ...
    with open("secret_keys_B.txt", "w") as f:
        print(hex(key_b_secret[0]), file=f)
        print(hex(key_b_secret[1]), file=f)
        print(hex(key_b_secret[2]), file=f)
